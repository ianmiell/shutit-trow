...
class shutit_trow(ShutItModule):
	...
	def build(self, shutit):
		...
		shutit.build['module_name'] = 'shutit_trow_' + ''.join(random.choice(string.ascii_letters + string.digits) for _ in range(6))
  ...
  config.vm.define "trow1" do |trow1|
    ...
    config.vm.provider :virtualbox do |vb|
      vb.name = "shutit_trow_1"
		...
		machines = {}
		machines.update({'trow1':{'fqdn':'trow1.vagrant.test'}})
...
def module():
	return shutit_trow(
		'git.shutit_trow.shutit_trow', 990267644.0001,
		description='',
		maintainer='',
